    ...
    BEGIN
        ...
        SELECT 
            ...
            CASE 
                ...
                ELSE TO_DATE(sls_order_dt::TEXT, 'YYYYMMDD') -- Fix here, cast integer to date
            END AS sls_order_dt,
            CASE 
                WHEN sls_ship_dt = 0 OR LENGTH(sls_ship_dt::TEXT) != 8 THEN NULL
                ELSE TO_DATE(sls_ship_dt::TEXT, 'YYYYMMDD') -- Fix here, cast integer to date
            END AS sls_ship_dt,
            CASE 
                WHEN sls_due_dt = 0 OR LENGTH(sls_due_dt::TEXT) != 8 THEN NULL
                ELSE TO_DATE(sls_due_dt::TEXT, 'YYYYMMDD') -- Fix here, cast integer to date
            END AS sls_due_dt,
            CASE 
